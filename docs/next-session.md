...
- 완료: 통합 에러 매핑 테스트 추가(`tests/unit/integration-error-mapping.unit.test.ts`) (401/403/404/429/5xx/timeout/unknown 경로)
...
2. 통합 에러 매핑 테스트에 네트워크 예외 케이스(ECONNRESET, fetch reject) 및 재시도 정책 assertion 보강
