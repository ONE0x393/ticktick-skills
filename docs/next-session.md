...
- 완료: 통합 에러 매핑 테스트 추가(`tests/unit/integration-error-mapping.unit.test.ts`) (401/403/404/429/5xx/timeout/ECONNRESET/fetch reject/unknown + retryable 5xx 복구 + non-retriable 4xx 무재시도 + 401/403 body variant)
...
2. 통합 에러 매핑 테스트에 429/5xx `retry-after` 헤더 기반 backoff 경로 assertion 보강
