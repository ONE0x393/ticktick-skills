...
- 완료: 통합 에러 매핑 테스트 추가(`tests/unit/integration-error-mapping.unit.test.ts`) (401/403/404/429/5xx/timeout/ECONNRESET/fetch reject/unknown + retryable 5xx 복구 + non-retriable 4xx 무재시도 경로)
...
2. 통합 에러 매핑 테스트에 401/403의 응답 바디 변형(빈 바디/텍스트 바디) 케이스 assertion 보강
